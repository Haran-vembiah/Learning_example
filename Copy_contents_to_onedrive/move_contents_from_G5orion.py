...
logging.basicConfig(
    filename=r'C:\Users\vembiah-1\OneDrive - Mettler Toledo LLC\copy_contents_to_onedrive\copy_update_G5Orion.log',
    level=logging.INFO,
    format='%(asctime)s - %(levelname)s - %(message)s',
    datefmt='%m/%d/%Y %I:%M:%S %p')

src = 'D:\G5_Orion'
dst = pathlib.Path(r"C:\Users\vembiah-1\OneDrive - Mettler Toledo LLC\G5_Orion")
